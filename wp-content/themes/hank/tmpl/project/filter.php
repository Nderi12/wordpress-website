...
$classes[] = sprintf( 'projects-filter-%s', hank_option( 'projects__filterableAlign' ) );
/**
 * Ignore fetching project terms when archive filter is
 * disabled
 */
if ( hank_option( 'projects__filterable' ) == 'on' ):
	$terms = array();
	$filter_type = hank_option( 'projects__filterableType' );
