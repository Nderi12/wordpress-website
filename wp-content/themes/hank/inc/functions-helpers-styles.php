 ...
 * @return  void
 */
function hank_define_style( $selector, array $attributes ) {
...
function hank_scheme_styles() {
	global $wp_filesystem;
	
	if ( hank_initialize_filesystem_api() ) {
		$content = $wp_filesystem->get_contents( HANK_PATH . 'assets/less/_color.less' );
		$colors  = hank_option( 'global__typography__scheme' );
 ...
 * @return  array
 */
function hank_typography_styles( array $options ) {
	$styles = array();

	if ( isset( $options['family'] ) && $family = hank_parse_font( $options['family'] ) ) {
...
function hank_parse_font( $font, $enqueue = true ) {
 ...
 * @return  array
 */
function hank_background_styles( $options ) {
	$styles = array();
 ...
 * @return  array
 */
function hank_border_styles( $options ) {
 ...
 * @return  string
 */
function hank_color_to_rgba( $color, $alpha ) {
